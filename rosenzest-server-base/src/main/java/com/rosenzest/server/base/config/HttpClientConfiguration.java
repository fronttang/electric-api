...
import com.rosenzest.server.base.interceptor.RestTemplateRequestNoInterceptor;
...
public class HttpClientConfiguration {
    ...
    @Bean
    public RestTemplateRequestNoInterceptor restTemplateTraceInterceptor() {
        return new RestTemplateRequestNoInterceptor();
    }
    ...
    public RestTemplate restTemplate() {
        ...
        restTemplate.setInterceptors(Arrays.asList(restTemplateTraceInterceptor()));
        return restTemplate;
    }
    ...
    public ConnectionKeepAliveStrategy connectionKeepAliveStrategy() {
        return (response, context) -> {
            ...
            Optional<Map.Entry<String, Integer>> any =
                Optional.ofNullable(properties.getKeepAliveTargetHost()).orElseGet(HashMap::new).entrySet().stream()
