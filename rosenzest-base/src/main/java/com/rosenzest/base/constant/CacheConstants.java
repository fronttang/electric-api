...
public interface CacheConstants {
	...
	/**
	 * 用户项目 CUST:userId:PROJECT:1
	 */
	String CUST_PROJECT_KEY = "CUST:{}:PROJECT:{}";

	/**
	 * 用户项目 CUST:userId:PROJECT
	 */
	String CUST_PROJECT_LIST_KEY = "CUST:{}:PROJECT";
	...
	static String getSensitiveWapperKey(String pattern, String replace, Class<? extends ISensitiveHandler> handler) {
		...
		String cacheKey = StrUtil.format("{}:{}{}{}", CacheConstants.SENSITIVE_WAPPER_KEY, pattern, replace,
				handlerBase64);
		return cacheKey;
	}
